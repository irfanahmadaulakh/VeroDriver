...
import ItemsList from './ExchangeReturnModal/Components/List'
import { List } from 'react-native-paper';



const TopHeaderExchange = (props) => {
  const { name, pickupFrom, serviceType, status } = props
  console.log("Props in TopHeaderExchange", props);
...
const { Layout, Images, Colors, Gutters } = useTheme()
  ...
  <VeroButton style={{width: WP('60')}} title="Arrive"
  onPress={props?.onPressArrive}
 />
...
<View style={styles.divider}></View>
    <Text style={styles.dimedText}>Items to Pick</Text>
    <List.Section>
      <List.Accordion
        title="Click to view items" style={{backgroundColor: Colors.white}}>
...
export default TopHeaderExchange;