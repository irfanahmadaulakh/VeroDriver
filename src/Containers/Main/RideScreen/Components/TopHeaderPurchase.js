...
import ItemsList from './ItemsPurchaseModal/Components/List'
import { List } from 'react-native-paper';



const TopHeaderPurchase = (props) => {
  const { name, pickupFrom, serviceType, status } = props
  console.log("Props in TopHeaderPurchase", props);
...
const { Layout, Images, Colors, Gutters } = useTheme()
 ...
 <View style={{padding: WP('4')}}>
    <Text style={styles.dimedText}>{t("pickupitem")}</Text>
...
export default TopHeaderPurchase;