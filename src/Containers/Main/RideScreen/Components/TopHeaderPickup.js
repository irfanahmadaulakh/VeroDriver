...
const TopHeaderPickup = (props) => {
  ...
  console.log("Props in TopHeaderPickup", props);
...
<View style={styles.divider}></View>
    <Text style={styles.dimedText}>Packages to Pick</Text>
    <List.Section>
      <List.Accordion
        title="Click to view packages" style={{backgroundColor: Colors.white}}>
