...
const DailyDetails = props => {
  console.log('props in summary daily', props)
    ...
    <ScrollView>
      ...
      <View style={styles.container}>
        <View style={styles.rowView}>
          <Text style={styles.text}>Trip fares</Text>
          <Text style={styles.text2}>$40.25</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.text}>YellowTaxi Fee</Text>
          <Text style={styles.text2}>$20.15</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.text}>+Tax</Text>
          <Text style={styles.text2}>$400.45</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.text}>+Tolls</Text>
          <Text style={styles.text2}>$64.85</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.text}>Surge</Text>
          <Text style={styles.text2}>$5.3</Text>
        </View>
        <View style={styles.rowView}>
          <Text style={styles.text}>Discount(-)</Text>
          <Text style={styles.text2}>$5.25</Text>
        </View>
        <View style={styles.divider3}></View>
        <View style={styles.rowView}>
          <Text
            style={[styles.text, { color: Colors.orange, fontWeight: 'bold' }]}
          >
            Your payment
          </Text>
          <Text
            style={[styles.text2, { color: Colors.orange, fontWeight: 'bold' }]}
          >
            $515.15
          </Text>
        </View>
