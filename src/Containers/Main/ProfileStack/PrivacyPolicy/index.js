...
At Vero 1  our mission is to improve people’s lives with the world’s best on demand services, including delivery and transportation, providing a platform to help users get from point A to point B. To do that, we need to collect, use, and share some of your personal information. This Privacy Policy is meant to help you understand how Vero 1  does that and how to exercise the choices and rights you have in your information. 
Vero 1 ’s privacy homepage provides additional information about our commitment to respecting your personal information, including ways for you to access and delete that information. 
The Scope of This Policy
This policy applies to all Vero 1  users, including Riders and Drivers (including Driver applicants), and to all Vero 1  platforms and services, including our apps, websites, features, and other services (collectively, the “Vero 1  Platform”). Please remember that your use of the Vero 1 Platform is also subject to our Terms of Service. 
The Information We Collect
When you use the Vero 1  Platform, we collect the information you provide, usage information, and information about your device. We also collect information about you from other sources like third-party services, and optional programs in which you participate, which we may combine with other information we have about you. Here are the types of information we collect about you: 
A. Information You Provide to Us
Account Registration. When you create an account with Vero 1 , we collect the information you provide us, such as your name, email address, phone number, birth date, and payment information. You may choose to share additional info with us for your Rider profile, like your photo or saved addresses (e.g., home or work), and set up other preferences (such as your preferred pronouns). 
...
B. Information We Collect When You Use the Vero 1  Platform
Location Information. Great rides start with an easy and accurate pickup. The Vero 1  Platform collects location information (including GPS and WiFi data) differently depending on your Vero 1  app settings and device permissions as well as whether you are using the platform as a Rider or Driver: 
•	Riders: We collect your device’s precise location when you open and use the Vero 1  app, including while the app is running in the background from the time you request a ride until it ends. Vero 1  also tracks the precise location of scooters and e-bikes at all times. 
...
•	Information to operationalize loyalty and promotional programs or applications, services, or features you choose to connect or link to your Vero 1  account, such as information about your use of such programs, applications, services, or features; and 
•	Information about you provided by specific services, such as demographic and market segment information. 
Enterprise Programs. If you use Vero 1  through your employer or other organization that participates in one of our Vero 1  Business enterprise programs, we will collect information about you from those parties, such as your name and contact information. 
Concierge Service. Sometimes another business or entity may order you a Vero 1  ride. If an organization has ordered a ride for you using our Concierge service, they will provide us your contact information and the pickup and drop-off location of your ride. 
Referral Programs. Friends help friends use the Vero 1  Platform. If someone refers you to Vero 1 , we will collect information about you from that referral including your name and contact information. 
...
•	Provide the Vero 1  Platform; 
•	Maintain the security and safety of the Vero 1  Platform and its users; 
•	Build and maintain the Vero 1  community; 
•	Provide customer support; 
•	Improve the Vero 1  Platform; and 
•	Respond to legal proceedings and obligations. 
Providing the Vero 1  Platform. We use your personal information to provide an intuitive, useful, efficient, and worthwhile experience on our platform. To do this, we use your personal information to: 
...
Maintaining the Security and Safety of the Vero 1  Platform and its Users. Providing you a secure and safe experience drives our platform, both on the road and on our apps. To do this, we use your personal information to: 
•	Authenticate users; 
...
•	Block and remove unsafe or fraudulent users from the Vero 1  Platform. 
Building and Maintaining the Vero 1  Community. Vero 1  works to be a positive part of the community. We use your personal information to: 
•	Communicate with you about events, promotions, elections, and campaigns; 
•	Personalize and provide content, experiences, communications, and advertising to promote and grow the Vero 1  Platform; and 
•	Help facilitate donations you choose to make through the Vero 1  Platform. 
...
•	Investigate and assist you in resolving questions or issues you have regarding the Vero 1  Platform; and 
•	Provide you support or respond to you. 
Improving the Vero 1  Platform. We are always working to improve your experience and provide you with new and helpful features. To do this, we use your personal information to: 
...
We do not sell your personal information. To make the Vero 1  Platform work, we may need to share your personal information with other users, third parties, and service providers. This section explains when and why we share your information. 
A. Sharing Between Vero 1  Users
Riders and Drivers.
Rider information shared with Driver: Upon receiving a ride request, we share with the Driver the Rider’s pickup location, name, profile photo, rating, Rider statistics (like approximate number of rides and years as a Rider), and information the Rider includes in their Rider profile (like preferred pronouns). Upon pickup and during the ride, we share with the Driver the Rider’s destination and any additional stops the Rider inputs into the Vero 1  app. Once the ride is finished, we also eventually share the Rider’s rating and feedback with the Driver. (We remove the Rider’s identity associated with ratings and feedback when we share it with Drivers, but a Driver may be able to identify the Rider that provided the rating or feedback.) 
Driver information shared with Rider: Upon a Driver accepting a requested ride, we will share with the Rider the Driver’s name, profile photo, preferred pronouns, rating, real-time location, and the vehicle make, model, color, and license plate, as well as other information in the Driver’s Vero 1  profile, such as information Drivers choose to add (like country flag and why you drive) and Driver statistics (like approximate number of rides and years as a Driver). 
...
Shared Ride Riders. When Riders use a Vero 1  Shared ride, we share each Rider’s name and profile picture to ensure safety. Riders may also see each other’s pickup and drop-off locations as part of knowing the route while sharing the ride. 
Rides Requested or Paid For by Others. Some rides you take may be requested or paid for by others. If you take one of those rides using your Vero 1  Business Profile account, a code or coupon, a subsidized program (e.g., transit or government), or a corporate credit card linked to another account, or another user otherwise requests or pays for a ride for you, we may share some or all of your ride details with that other party, including the date, time, charge, rating given, region of trip, and pick up and drop off location of your ride. 
Referral Programs. If you refer someone to the Vero 1  Platform, we will let them know that you generated the referral. If another user referred you, we may share information about your use of the Vero 1  Platform with that user. For example, a referral source may receive a bonus when you join the Vero 1  Platform or complete a certain number of rides and would receive such information. 
B. Sharing With Third-Party Service Providers for Business Purposes
Depending on whether you’re a Rider or a Driver, Vero 1  may share the following categories of your personal information for a business purpose (as we have done for the preceding 12 months) to provide you with a variety of the Vero 1  Platform’s features and services: 
...
•	Maintaining and servicing your Vero 1  account; 
...
•	Providing marketing and advertising services to Vero 1 ; 
•	Providing financing; 
•	Providing requested emergency services; 
•	Providing analytics services to Vero 1 ; and 
•	Undertaking internal research to develop the Vero 1  Platform. 
C. For Legal Reasons and to Protect the Vero 1  Platform
...
We retain your information for as long as necessary to provide you and our other users the Vero 1  Platform. This means we keep your profile information for as long as you maintain an account. We retain transactional information such as rides and payments for at least seven years to ensure we can perform legitimate business functions, such as accounting for tax obligations. If you request account deletion, we will delete your information as set forth in the “Deleting Your Account” section below. 
...
As explained more below and on our privacy homepage, Vero 1  provides ways for you to access and delete your personal information as well as exercise other data rights that give you certain control over your personal information. 
A. All Users
Email Subscriptions. You can always unsubscribe from our commercial or promotional emails by clicking unsubscribe in those messages. We will still send you transactional and relational emails about your use of the Vero 1  Platform. 
Text Messages. You can opt out of receiving commercial or promotional text messages by texting the word END to 46080 from the mobile device receiving the messages. You may also opt out of receiving all texts from Vero 1  (including transactional or relational messages) by texting the word STOPALL to 46080 from the mobile device receiving the messages. Note that opting out of receiving all texts may impact your use of the Vero 1  Platform. Drivers can also opt out of driver-specific messages by texting STOP in response to a driver SMS. To re-enable texts you can text START in response to an unsubscribe confirmation SMS. 
Push Notifications. You can opt out of receiving push notifications through your device settings. Please note that opting out of receiving push notifications may impact your use of the Vero 1  Platform (such as receiving a notification that your ride has arrived). 
...
Location Information. You can prevent your device from sharing location information through your device’s system settings. But if you do, this may impact Vero 1 ’s ability to provide you our full range of features and services. 
Cookie Tracking. You can modify your cookie settings on your browser, but if you delete or choose not to accept our cookies, you may be missing out on certain features of the Vero 1  Platform. 
Do Not Track. Your browser may offer you a “Do Not Track” option, which allows you to signal to operators of websites and web applications and services that you do not want them to track your online activities. The Vero 1  Platform does not currently support Do Not Track requests at this time. 
Deleting Your Account. If you would like to delete your Vero 1  account, please visit our privacy homepage. In some cases, we will be unable to delete your account, such as if there is an issue with your account related to trust, safety, or fraud. When we delete your account, we may retain certain information for legitimate business purposes or to comply with legal or regulatory obligations. For example, we may retain your information to resolve open insurance claims, or we may be obligated to retain your information as part of an open legal claim. When we retain such data, we do so in ways designed to prevent its use for other purposes. 
